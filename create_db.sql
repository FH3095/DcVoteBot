...
ALTER TABLE voters_votes
  ADD KEY idx_voters_votes_voteOptionId (voteOptionId) USING BTREE;
ALTER TABLE voters_votes
  ADD KEY idx_voters_votes_voterId (voterId) USING BTREE;
...
ALTER TABLE vote_options
  ADD PRIMARY KEY (id);
ALTER TABLE vote_options
  ADD UNIQUE KEY idx_vote_options_messageId_title (messageId,title) USING BTREE;
ALTER TABLE vote_options
  ADD KEY idx_vote_options_messageId (messageId) USING BTREE;
